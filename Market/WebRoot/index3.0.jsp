...
<body>
    ...
    <div id="left">
    	<div id="leftcontent">
    		<iframe src="left1.jsp" frameborder=0 height=600 scrolling="no" width=200 marginheight=0 marginwidth=0 seamless="seamless"></iframe>
    	</div>
    </div>
    <div id="right">
    	<div id="menu">
    	...
    	<iframe id="main" name="main" width=1062 height=530 marginheight="10" scrolling="no"
