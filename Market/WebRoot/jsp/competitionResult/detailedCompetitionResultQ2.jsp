			...
			<div class="panel-body">
				...
				<div id="yesReleaseResult" style="display:none">
					...
					<ul>
						...
						<li><a href="javascript:void(0)" onclick="everyCompanyMarketShare()">各公司细分市场销售量</a></li>
...
function everyCompanyMarketShare(){
	var competitionId=$("#competitionId").val();
	var quarter=$("#quarter").val();
	window.parent.main.location.href="competitionResult/everyCompanyMarketShare.do?competitionId="+competitionId+"&currentQuarter="+quarter;
}
