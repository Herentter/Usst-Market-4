...
<body>
	<div id="content">
		<div class="row" id="row1">
			<div class="col-md-3">
				<div id="top_left">
					<a href="javascript:void(0)" id="quarterSubtract"><i class=" fa fa-caret-left"></i></a> &nbsp;&nbsp;<span>季度</span><span id="quarter">${competition.currentQuarter }</span>&nbsp;&nbsp;
		...
		<div class="row" id="row2">
			<div class="col-md-3"
				...
				<ul id="accordion" class="accordion">
					<li>
						<div class="link">
							当前季度决策<i class="fa fa-caret-right"></i>
						</div>
						<ul class="submenu">
			...
			<div class="col-md-9">
				<iframe id="myiframe"
					src="policyDecision/keyDecision.do?competitionId=${competition.id }&currentQuarter=${competition.currentQuarter }"
	...
	<script type="text/javascript">
        ...
        function errorAndWarn(){
        	var competitionId=$("#competitionId").val();
        	var quarter=$("#quarter").text();
        	window.parent.main.location.href="policyDecision/errorAndWarn.do?competitionId="+competitionId+"&currentQuarter="+quarter;
        }
        
        function decisionSummary(){
        	var competitionId=$("#competitionId").val();
        	var quarter=$("#quarter").text();
        	window.parent.main.location.href="policyDecision/decisionSummary.do?competitionId="+competitionId+"&currentQuarter="+quarter;
        }
