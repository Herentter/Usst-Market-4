						...
						<table class="table table-bordered">
							...
							<c:forEach items="${SLVoList}" var="items">
								<tr>
									...
									<td><fmt:formatNumber type="number" value="${2500/operationCapacityList[0].operateCapacity+100}"
										pattern="0" maxFractionDigits="0" /></td>
									<td><fmt:formatNumber type="number" value="${items.companyProducts.cost+5000/operationCapacityList[0].operateCapacity+5*operationCapacityList[0].operateCapacity+100}"
										pattern="0" maxFractionDigits="0" /></td>
