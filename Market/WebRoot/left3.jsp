...
<body>
	...
	<ul class="nav">
		...
		<li><a href="#none">人力资源<i></i></a>
			<ul>
				<li><a href="showAllSalesSalary.do?quarter=2" target="main">业内销售人员薪酬</a></li>
				<li><a href="showSalesSalary.do?quarter=3" target="main">销售人员薪酬</a></li>
				<li><a href="showAllWorkersSalary.do?quarter=2" target="main">业内工厂工人薪酬</a></li>
				<li><a href="showWorkersSalary.do?quarter=3" target="main">工厂工人薪酬</a></li>
			</ul></li>
		...
		<li><a href="#none">财务<i></i></a>
			<ul>
				<li><a href="showShareHold.do?quarter=3" target="main">内部持股</a></li>
				<li><a href="showFixedDeposite.do?quarter=3" target="main">定期存款</a></li>
			</ul></li>

		<li><a href="#none">财会预算<i></i></a>
			<ul>
				<li><a href="showCashFlow.do?quarter1=3" target="main">现金流表</a></li>
