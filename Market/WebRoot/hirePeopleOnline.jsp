                	...
                	<form action="" method="post">
	                    <table class="table table-bordered">
	                        ...
	                        <tbody>
	                        	...
	                        	<tr>
	                        		<td>
	                        		<input class="form-control data" type="text" name="saleman"
	                                           value="${hirePeopleOnline.saleman }"
	                                           onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
	                                           onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}">
	                        		</td>
	                        		<td>
	                        		<input class="form-control data" type="text" name="afterSale"
	                        		...
	                        		<td><input class="btn btn-info" type="button" class="btn-info" onclick="sign()" value="提交"/></td>
