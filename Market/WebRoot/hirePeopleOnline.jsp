		...
		<div class="panel-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="notice2">
                	<form action="updateHirePeopleOnline.do?quarter=2" method="post">
	                	<table class="table table-bordered">
	                		...
	                		<c:forEach items="${hirePeopleOnlineVoList }" var="item" varStatus="status">
		                		<input type="hidden" name="hirePeopleOnlineList[${status.index }].id" value="${item.hirePeopleOnline.id }">
		                		<tr>
		                			<td>${item.city }</td>
		                			
		                			<td><input type="text" name="hirePeopleOnlineList[${status.index }].saleman" value="${item.hirePeopleOnline.saleman }"></td>
		                			<td><input type="text" name="hirePeopleOnlineList[${status.index }].afterSale" value="${item.hirePeopleOnline.afterSale }"></td>
		                		</tr>
	                		</c:forEach>
