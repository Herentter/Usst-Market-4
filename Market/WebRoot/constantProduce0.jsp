                	...
                	<div class="course_content">
                   	...
                   	<div class="left">
                   		...
                   		<div class="left_content">
                   			...
                   			<ul>
                   				<li>
                   					选择工厂的固定产能。 您必须决定为市场测试阶段兴建的生产线规模。 工厂产能由每日和每季度的生产量来衡量。 工厂每周可以运行 5 天，每季度生产 13 周。 也就是每季度 65 天
								</li>
                   				<li>
                   	...
                   	<div class="right">
                   		...
                   		<div class="right_content">
                   			<ul>
                   				<li>在进行市场测试的最初阶段，公司的销量不大可能高于每天 10 件，或者说每季度 650 件。 您可能需要通过一到两个季度的时间来学习如何面向手机行业进行市场营销，以及树立您的品牌知名度。 因此，在公司运营的初期，您并不需要一个产能巨大的工厂。 之外，购买大于每天 50 件的固定产能在资金上也不可行。</li>
                   				<li>固定产能的增加将有一个季度的时滞。 也就是说，如果您在第三季度投资将固定产能扩大25 件/天，那么在第四季度之前您将无法使用新增的产能。 从第四季度开始，您才能使用新增的产能（25件/天）。 此，提前为将来做打算很重要。您应当提前估算未来一到两个季度的市场需求量，然后对固定产能作出相应的规划。 如果扩张了销售渠道，您需要相应地扩大固定产能。 如果您增添了新的品牌和新的销售人员，同样也应当考虑按需扩大固定产能。</li>
