...
<body>
    ...
    <div id="container">
        <ul class="nav1">
            ...
            <li><a href="#
            " onclick="designCompetition();">设计竞赛</a></li>
            <li><a href="#">关于我们</a></li>
        </ul>
        <!-- 滚动图片 -->
       ...
       <!--  <div id="bgimage">
        ...
        <div><a href="checkCompetition.do?competitionId=9">审核竞赛</a></div>
    ...
    <script type="text/javascript">
        ...
        function teacherQuery(){
    		window.open("jsp/teacherQuery/teacherQuery.jsp",'newwindow', 'height=590, width=1100, top=60, left=90, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=yes, status=no')
    	}
        
        function teacherReference(){
            window.open('teacherReferenceBook.do', 'newwindow', 'height=620, width=800, top=60, left=160, toolbar=no, menubar=no, scrollbars=yes, resizable=no, location=yes, status=no')
        }
