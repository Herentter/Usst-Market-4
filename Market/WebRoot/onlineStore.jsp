        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade in active" id="notice2">
                ...
                <form id="form1" role="form" method="post" action="">
                    ...
                    <input type="hidden" name="quarter" value="${companyMarket.quarter}">
                    <div id="region">
                        <div id="china" class="branch">
                            <figure class="test1">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty companyMarket}">
                                            <c:if test="${companyMarket.isPhy==0}">
                                                是否开设:<input type="checkbox" class="chk_1" name="setup" value="0" checked="checked"/>
                                            </c:if>
                                            <c:if test="${companyMarket.isPhy==1}">
                                                是否开设:<input type="checkbox" class="chk_1" name="setup" value="1"/>
                                            </c:if>
                                        </c:when>
                                        <c:otherwise>
                                            是否开设:<input type="checkbox" class="chk_1" name="setup" value="1"/>
                                ...
                                <figcaption>
                                    ...
                                    <br><br>
                                    <p>开设成本：${webList[0].open }元</p>
                                    <p>租赁成本：${webList[0].rent }元</p>
                                    <br><br>
