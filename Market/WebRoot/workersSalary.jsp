...
<body onLoad="init()">
	<div class="panel panel-info">
		<div class="panel-heading">工厂工人薪酬</div>
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="notice1">
					...
					<div class="left">
						...
						<div class="left_content">您必须决定工厂工人的工资及福利。</div>
					</div>
					...
					<form class="form-horizontal" id="form" method="post"
						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									<td>工资</td>
									<td><input id="salary" class="form-control" type="text" name="salary" value="0" onchange="aa()">
									<input type="hidden" value="${workersSalaryList[0].salary}" id="hidden_salary"/>元</td>
								</tr>
								<tr>
									<td>福利</td>
									<td><input id="welfare" class="form-control" type="text"
										name="welfare" value="0" onchange="a1()">
										<input type="hidden" value="${workersSalaryList[0].welfare}" id="hidden_welfare"/>%</td>
								</tr>
								<tr>
									<td>休假</td>
									<td><input id="holiday" class="form-control" type="text"
										name="holiday" value="0" onchange="a2()">
										<input type="hidden" value="${workersSalaryList[0].holiday}" id="hidden_holiday"/>天</td>
								</tr>
								<tr>
									<td>公积金</td>
									<td><input id="publicFund" class="form-control" type="text"
										name="publicFund" value="0" onchange="a3()">
										<input type="hidden" value="${workersSalaryList[0].publicFund}" id="hidden_publicFund"/>%</td>
								</tr>
								<tr>
									<td>企业年金</td>
									<td><input id="companyPension" class="form-control" type="text"
										name="companyPension" value="0" onchange="a4()">
										<input type="hidden" value="${workersSalaryList[0].companyPension}" id="hidden_companyPension"/>%</td>
								</tr>
								<tr>
									<td>退休金</td>
									<td><input id="retiredPay" class="form-control" type="text"
										name="retiredPay" value="0" onchange="a5()">
										<input type="hidden" value="${workersSalaryList[0].retiredPay}" id="hidden_retiredPay"/>%</td>
								</tr>
								<tr>
									<td>年度薪酬组合总额</td>
