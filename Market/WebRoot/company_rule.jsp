            ...
            <div class="panel-body">
	            ...
	            <div class="tab-content">
	                ...
	                <div class="tab-pane fade" id="notice2">
	                	<form id="form1" class="form-horizontal" role="form" method="post" action="updateCompanyRule.do?quarter=${quarter }" >
			                    ...
			                    <div class="form-group btn-grounp">
			                        ...
			                        <div class="col-md-8 col-xs-8">
			                        	<c:forEach items="${entry.value}" var="item">
				                            <div class="">     
				                                <input type="checkbox" name="${entry.key }" value="${item.id }" onclick="check(this)" ><label>${item.detail}</label>
				                            </div>
			                            </c:forEach>
			                        </div>
		                   ...
		                   <input id="myHidden" type="hidden" name="myHidden" value="${companyRule.ruleId }"/>
		                    <div id="btndiv">
...
<script type="text/javascript">
	...
	function check(obj){
		...
		if(obj.name=="决策制定流程"){
		 	...
		 	if(obj.checked==true){
		 		var aa = document.getElementsByName("决策制定流程");
	...
	//判断团队规则
	var obj=document.getElementsByName("团队规则");
	var flag=false;
	...
	//判断决策流程
	var obj=document.getElementsByName("决策制定流程");
	var flag=false;
	for(var i=0;i<obj.length;i++){
		if(obj[i].checked){
			flag=true;
