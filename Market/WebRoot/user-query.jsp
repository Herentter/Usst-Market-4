		...
		<div class="row">
			<section>
				<div class="col-lg-8 col-lg-offset-2">
					...
					<form id="queryUser" method="post" class="form-horizontal"
						action="queryUser.do">

						<div class="form-group">
							<label class="col-sm-3 control-label">请选择查询的用户的类型</label>
							<div class="col-sm-8">
								<select type="select" class="form-control" class="select_type"
									name="select_type">
