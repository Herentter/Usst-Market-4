...
<ul class="nav"> 
   ...
   <li>
        ...
        <ul>
            ...
            <li><a href="#" target="main">定价</a>
                <ul>
                    ...
                    <li><a href="showSoldCost.do" target="main">生产成本</a></li>
                    <li><a href="showProductPrice.do" target="main">产品定价</a></li>
                </ul>
            </li>
    ...
    <li>
        ...
        <ul>
        	<li><a href="policyDecision/companyDecisionSummary.do?companyId=<%=request.getParameter("companyId") %> &currentQuarter=2" target="main">决策汇总</a></li>
