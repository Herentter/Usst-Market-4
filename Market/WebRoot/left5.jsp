...
<ul class="nav"> 
   <li>
        <a href="#none">业绩报告<i></i></a>
        <ul>
        	<li><a href="showCashFlow.do" target="main">市场份额</a></li>
        	<li><a href="showCashFlow.do" target="main">各渠道销售量</a></li>
            <li><a href="showCashFlow.do" target="main">现金流表</a></li>
            <li><a href="showIncomeStatement.do " target="main">利润表</a></li>
            <li><a href="showBalanceSheet.do" target="main">资产负债表</a></li>
            <li><a href="showBalanceSheet.do" target="main">平衡积分卡</a></li>
            <li><a href="showCashFlow.do" target="main">财务比率</a></li>
            <li><a href="showCashFlow.do" target="main">策略图表</a></li>
            <li><a href="showCashFlow.do" target="main">累计平衡记分卡</a></li>
   			<li><a href="showCashFlow.do" target="main">需求量和客户反感</a></li>
        </ul>
   </li> 
   <li>
        <a href="#none">市场调研<i></i></a>
        <ul>
        	<li><a href="showCashFlow.do" target="main">品牌评价</a></li>
        	<li><a href="showCashFlow.do" target="main">竞争对手的品牌</a></li>
            <li><a href="showCashFlow.do" target="main">品牌详细需求报告</a></li>
            <li><a href="showIncomeStatement.do " target="main">各渠道需求量</a></li>
            <li><a href="showBalanceSheet.do" target="main">各城市的竞争对手</a></li>
            <li><a href="showBalanceSheet.do" target="main">竞争对手的销售人员</a></li>
            <li><a href="showCashFlow.do" target="main">竞争对手的网络销售决策</a></li>
            <li><a href="showCashFlow.do" target="main">价格评价</a></li>
            <li><a href="showCashFlow.do" target="main">竞争对手的价格</a></li>
   			<li><a href="showCashFlow.do" target="main">广告评价</a></li>
   			<li><a href="showCashFlow.do" target="main">竞争对手的广告</a></li>
   			<li><a href="showCashFlow.do" target="main">业内销售人员薪酬</a></li>
   			<li><a href="showCashFlow.do" target="main">业内工厂工人薪酬</a></li>
        </ul>
   </li> 
   <li>
        ...
        <ul>
            <li>
                ...
                <ul>
                    <li><a href="customRequired.jsp" target="main">品牌盈利能力</a></li>
                    <li><a href="productUse.jsp" target="main">产品性能评测</a></li>
                    <li><a href="productUse.jsp" target="main">品牌评价</a></li>
                    <li><a href="productUse.jsp" target="main">竞争对手的品牌</a></li>
                    <li><a href="productUse.jsp" target="main">设计品牌</a></li>
                    <li><a href="productUse.jsp" target="main">研发投资</a></li>
                </ul>

            </li>
            <li><a href="#" target="main">定价</a>
                <ul>
                    <li><a href="marketPrice.jsp" target="main">价格评价</a></li>
                    <li><a href="marketPrice.jsp" target="main">竞争对手的价格</a></li>
                    <li><a href="marketPrice.jsp" target="main">生产成本</a></li>
                    <li><a href="marketPrice.jsp" target="main">价格及销售优先级别</a></li>
                </ul>
            </li>
            <li><a href="#" target="main">广告</a>
                <ul>
                    <li><a href="customRequired.jsp" target="main">广告效果评测</a></li>
                    <li><a href="marketPrice.jsp" target="main">广告评价</a></li>
                    <li><a href="marketPrice.jsp" target="main">竞争对手的广告</a></li>
                    <li><a href="marketPrice.jsp" target="main">媒体偏好</a></li>
                    <li><a href="marketPrice.jsp" target="main">主流媒体投放</a></li>
                    <li><a href="marketPrice.jsp" target="main">核查广告语</a></li>
   ...
   <li>
        ...
        <ul>
            ...
            <li><a href="#" target="main">实体销售中心</a>
                <ul>
                    ...
                    <li><a href="marketScale.jsp" target="main">雇佣销售人员</a></li>
            ...
            <li><a href="#" target="main">网络销售中心</a>
                <ul>
                    ...
                    <li><a href="netAccess.jsp" target="main">网络销售及 支持</a></li>
                    <li><a href="netEfficiency.jsp" target="main">网站访问量</a></li>
    ...
    <li>
        ...
        <ul>
        	<li><a href="requirePredict.jsp" target="main">上季度结果</a></li>
        	<li><a href="requirePredict.jsp" target="main">竞争力</a></li>
        	<li><a href="requirePredict.jsp" target="main">无用库存测</a></li>
    ...
    <li>
        ...
        <ul>
            <li><a href="cashTable.jsp" target="main">股权历史</a></li>
