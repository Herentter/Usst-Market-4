...
public class PysicalPathServiceImpl implements PysicalPathService{
	...
	@Override
	public List<PysicalEmploeePo> getPopulationbyCompanyid(PysicalEmploeeVo vo) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<PysicalEmploeePo> getPopulationbyCompanyid(int companyid,int quater) {
		// TODO Auto-generated method stub
	...
	@Override
	public int[] salary(int companyid, int quater) {
		// TODO Auto-generated method stub
		/**
		 * 注意：
